...
var _ = Describe("Quote", func() {
	DescribeTable("examples", func(in any, out string) {
		...
		Entry("URL ptr", new(unwrap(url.Parse("https://localhost"))), "https://localhost"),
		Entry("Regexp", regexp.MustCompile("blc"), "blc"),
		Entry("Regexp ptr", new(regexp.MustCompile("blc")), "blc"),
		Entry("IP", net.ParseIP("127.0.0.1"), "127.0.0.1"),
		Entry("IP ptr", new(net.ParseIP("127.0.0.1")), "127.0.0.1"),
