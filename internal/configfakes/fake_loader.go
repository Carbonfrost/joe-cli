...
func (fake *FakeLoader) Load(arg1 context.Context) (config.Store, error) {
	fake.loadMutex.Lock()
...
func (fake *FakeLoader) LoadCalls(stub func(context.Context) (config.Store, error)) {
	fake.loadMutex.Lock()
	defer fake.loadMutex.Unlock()
	fake.LoadStub = stub
}

func (fake *FakeLoader) LoadArgsForCall(i int) context.Context {
	fake.loadMutex.RLock()
	defer fake.loadMutex.RUnlock()
...
func (fake *FakeLoader) LoadReturns(result1 config.Store, result2 error) {
	fake.loadMutex.Lock()
	defer fake.loadMutex.Unlock()
	fake.LoadStub = nil
...
func (fake *FakeLoader) LoadReturnsOnCall(i int, result1 config.Store, result2 error) {
	fake.loadMutex.Lock()
	defer fake.loadMutex.Unlock()
	fake.LoadStub = nil
